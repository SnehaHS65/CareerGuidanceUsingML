...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-left">
            <div class="single-well">
              <a href="#">
								  <img src="img/ebsl_section_courses.jpg" alt="">
								</a>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
          </div>
        </div>
        ...
        <asp:TextBox ID="txtUserId" runat="server" Width="400px" Height="30px" placeholder="ENTER USERID" ></asp:TextBox>
            ...
            <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" Width="400px" placeholder="ENTER PASSWORD"
